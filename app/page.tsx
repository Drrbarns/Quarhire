...
export default function Home() {
  const jsonLd = {
    ...
    '@type': 'LocalBusiness',
    '@id': 'https://quarhire.com',
    name: 'Quarhire',
    description: 'Professional airport pickup and transfer services in Ghana',
    url: 'https://quarhire.com',
    telephone: '+233240665648',
    priceRange: 'GHS 600 - GHS 2000',
    image: 'https://quarhire.com/Quarhire2.png',
    address: {
      '@type': 'PostalAddress',
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            '@type': 'Service',
            name: 'City Transfers',
            description: 'Comfortable transportation for business meetings and appointments',
          },
        },
        {
          '@type': 'Offer',
          itemOffered: {
            '@type': 'Service',
            name: 'Hourly Hire',
            description: 'Flexible transportation service on your schedule',
          },
        },
      ],
    },
